...
return cljs.core.merge.call(null,initial_state,p1__25847_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_25848 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_25849 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_25848);
var pos_25850 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_25848);
quil.core.scale.call(null,zoom_25849);

var tr__20785__auto___25851 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_25849) - cljs.core.first.call(null,pos_25850)),(((quil.core.height.call(null) / (2)) / zoom_25849) - cljs.core.second.call(null,pos_25850))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__20785__auto___25851);
