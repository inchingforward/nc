...
var vec__25856 = axis;
var a_x = cljs.core.nth.call(null,vec__25856,(0),null);
var a_y = cljs.core.nth.call(null,vec__25856,(1),null);
var a_z = cljs.core.nth.call(null,vec__25856,(2),null);
var vec__25857 = v;
var x = cljs.core.nth.call(null,vec__25857,(0),null);
var y = cljs.core.nth.call(null,vec__25857,(1),null);
var z = cljs.core.nth.call(null,vec__25857,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__25858,p__25859){
var vec__25862 = p__25858;
var u1 = cljs.core.nth.call(null,vec__25862,(0),null);
var u2 = cljs.core.nth.call(null,vec__25862,(1),null);
var u3 = cljs.core.nth.call(null,vec__25862,(2),null);
var vec__25863 = p__25859;
var v1 = cljs.core.nth.call(null,vec__25863,(0),null);
var v2 = cljs.core.nth.call(null,vec__25863,(1),null);
var v3 = cljs.core.nth.call(null,vec__25863,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__25864_SHARP_){
return (p1__25864_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__25865_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__25866_SHARP_,angle_lr),angle_ud);
...
var map__25872 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__25872__$1 = ((cljs.core.seq_QMARK_.call(null,map__25872))?cljs.core.apply.call(null,cljs.core.hash_map,map__25872):map__25872);
var up = cljs.core.get.call(null,map__25872__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__25872__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4421__auto__ = (function (){var pred__25873 = cljs.core._EQ_;
var expr__25874 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__25873.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__25874))){
return straight;
} else {
if(cljs.core.truth_(pred__25873.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__25874))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__25873.call(null,quil.middlewares.navigation_3d.space,expr__25874))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__25873.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__25874))){
return up;
} else {
if(cljs.core.truth_(pred__25873.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__25874))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__25873.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__25874))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4421__auto__,map__25872,map__25872__$1,up,straight){
return (function (p1__25867_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__25867_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4421__auto__,map__25872,map__25872__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__25876_SHARP_);
});})(initial_state))
);
});
/**
...
var map__25881_25885 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__25881_25886__$1 = ((cljs.core.seq_QMARK_.call(null,map__25881_25885))?cljs.core.apply.call(null,cljs.core.hash_map,map__25881_25885):map__25881_25885);
var vec__25882_25887 = cljs.core.get.call(null,map__25881_25886__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_25888 = cljs.core.nth.call(null,vec__25882_25887,(0),null);
var c_y_25889 = cljs.core.nth.call(null,vec__25882_25887,(1),null);
var c_z_25890 = cljs.core.nth.call(null,vec__25882_25887,(2),null);
var vec__25883_25891 = cljs.core.get.call(null,map__25881_25886__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_25892 = cljs.core.nth.call(null,vec__25883_25891,(0),null);
var u_y_25893 = cljs.core.nth.call(null,vec__25883_25891,(1),null);
var u_z_25894 = cljs.core.nth.call(null,vec__25883_25891,(2),null);
var vec__25884_25895 = cljs.core.get.call(null,map__25881_25886__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_25896 = cljs.core.nth.call(null,vec__25884_25895,(0),null);
var p_y_25897 = cljs.core.nth.call(null,vec__25884_25895,(1),null);
var p_z_25898 = cljs.core.nth.call(null,vec__25884_25895,(2),null);
quil.core.camera.call(null,p_x_25896,p_y_25897,p_z_25898,(p_x_25896 + c_x_25888),(p_y_25897 + c_y_25889),(p_z_25898 + c_z_25890),u_x_25892,u_y_25893,u_z_25894);
