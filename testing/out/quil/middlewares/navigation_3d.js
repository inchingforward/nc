...
var vec__23951 = axis;
var a_x = cljs.core.nth.call(null,vec__23951,(0),null);
var a_y = cljs.core.nth.call(null,vec__23951,(1),null);
var a_z = cljs.core.nth.call(null,vec__23951,(2),null);
var vec__23952 = v;
var x = cljs.core.nth.call(null,vec__23952,(0),null);
var y = cljs.core.nth.call(null,vec__23952,(1),null);
var z = cljs.core.nth.call(null,vec__23952,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__23953,p__23954){
var vec__23957 = p__23953;
var u1 = cljs.core.nth.call(null,vec__23957,(0),null);
var u2 = cljs.core.nth.call(null,vec__23957,(1),null);
var u3 = cljs.core.nth.call(null,vec__23957,(2),null);
var vec__23958 = p__23954;
var v1 = cljs.core.nth.call(null,vec__23958,(0),null);
var v2 = cljs.core.nth.call(null,vec__23958,(1),null);
var v3 = cljs.core.nth.call(null,vec__23958,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__23959_SHARP_){
return (p1__23959_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__23960_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__23961_SHARP_,angle_lr),angle_ud);
...
var map__23967 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__23967__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__23967__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4421__auto__ = (function (){var pred__23968 = cljs.core._EQ_;
var expr__23969 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__23968.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__23969))){
return straight;
} else {
if(cljs.core.truth_(pred__23968.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__23969))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__23968.call(null,quil.middlewares.navigation_3d.space,expr__23969))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__23968.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__23969))){
return up;
} else {
if(cljs.core.truth_(pred__23968.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__23969))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__23968.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__23969))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4421__auto__,map__23967,map__23967__$1,up,straight){
return (function (p1__23962_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__23962_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4421__auto__,map__23967,map__23967__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__23971_SHARP_);
});})(initial_state))
);
});
/**
...
var map__23976_23980 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__23976_23981__$1 = ((cljs.core.seq_QMARK_.call(null,map__23976_23980))?cljs.core.apply.call(null,cljs.core.hash_map,map__23976_23980):map__23976_23980);
var vec__23977_23982 = cljs.core.get.call(null,map__23976_23981__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_23983 = cljs.core.nth.call(null,vec__23977_23982,(0),null);
var c_y_23984 = cljs.core.nth.call(null,vec__23977_23982,(1),null);
var c_z_23985 = cljs.core.nth.call(null,vec__23977_23982,(2),null);
var vec__23978_23986 = cljs.core.get.call(null,map__23976_23981__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_23987 = cljs.core.nth.call(null,vec__23978_23986,(0),null);
var u_y_23988 = cljs.core.nth.call(null,vec__23978_23986,(1),null);
var u_z_23989 = cljs.core.nth.call(null,vec__23978_23986,(2),null);
var vec__23979_23990 = cljs.core.get.call(null,map__23976_23981__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_23991 = cljs.core.nth.call(null,vec__23979_23990,(0),null);
var p_y_23992 = cljs.core.nth.call(null,vec__23979_23990,(1),null);
var p_z_23993 = cljs.core.nth.call(null,vec__23979_23990,(2),null);
quil.core.camera.call(null,p_x_23991,p_y_23992,p_z_23993,(p_x_23991 + c_x_23983),(p_y_23992 + c_y_23984),(p_z_23993 + c_z_23985),u_x_23987,u_y_23988,u_z_23989);
