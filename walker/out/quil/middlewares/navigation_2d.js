...
return cljs.core.merge.call(null,initial_state,p1__25850_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_25851 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_25852 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_25851);
var pos_25853 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_25851);
quil.core.scale.call(null,zoom_25852);

var tr__20785__auto___25854 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_25852) - cljs.core.first.call(null,pos_25853)),(((quil.core.height.call(null) / (2)) / zoom_25852) - cljs.core.second.call(null,pos_25853))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__20785__auto___25854);
