...
var vec__25859 = axis;
var a_x = cljs.core.nth.call(null,vec__25859,(0),null);
var a_y = cljs.core.nth.call(null,vec__25859,(1),null);
var a_z = cljs.core.nth.call(null,vec__25859,(2),null);
var vec__25860 = v;
var x = cljs.core.nth.call(null,vec__25860,(0),null);
var y = cljs.core.nth.call(null,vec__25860,(1),null);
var z = cljs.core.nth.call(null,vec__25860,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__25861,p__25862){
var vec__25865 = p__25861;
var u1 = cljs.core.nth.call(null,vec__25865,(0),null);
var u2 = cljs.core.nth.call(null,vec__25865,(1),null);
var u3 = cljs.core.nth.call(null,vec__25865,(2),null);
var vec__25866 = p__25862;
var v1 = cljs.core.nth.call(null,vec__25866,(0),null);
var v2 = cljs.core.nth.call(null,vec__25866,(1),null);
var v3 = cljs.core.nth.call(null,vec__25866,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__25867_SHARP_){
return (p1__25867_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__25868_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__25869_SHARP_,angle_lr),angle_ud);
...
var map__25875 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__25875__$1 = ((cljs.core.seq_QMARK_.call(null,map__25875))?cljs.core.apply.call(null,cljs.core.hash_map,map__25875):map__25875);
var up = cljs.core.get.call(null,map__25875__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__25875__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4421__auto__ = (function (){var pred__25876 = cljs.core._EQ_;
var expr__25877 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__25876.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__25877))){
return straight;
} else {
if(cljs.core.truth_(pred__25876.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__25877))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__25876.call(null,quil.middlewares.navigation_3d.space,expr__25877))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__25876.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__25877))){
return up;
} else {
if(cljs.core.truth_(pred__25876.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__25877))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__25876.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__25877))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4421__auto__,map__25875,map__25875__$1,up,straight){
return (function (p1__25870_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__25870_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4421__auto__,map__25875,map__25875__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__25879_SHARP_);
});})(initial_state))
);
});
/**
...
var map__25884_25888 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__25884_25889__$1 = ((cljs.core.seq_QMARK_.call(null,map__25884_25888))?cljs.core.apply.call(null,cljs.core.hash_map,map__25884_25888):map__25884_25888);
var vec__25885_25890 = cljs.core.get.call(null,map__25884_25889__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_25891 = cljs.core.nth.call(null,vec__25885_25890,(0),null);
var c_y_25892 = cljs.core.nth.call(null,vec__25885_25890,(1),null);
var c_z_25893 = cljs.core.nth.call(null,vec__25885_25890,(2),null);
var vec__25886_25894 = cljs.core.get.call(null,map__25884_25889__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_25895 = cljs.core.nth.call(null,vec__25886_25894,(0),null);
var u_y_25896 = cljs.core.nth.call(null,vec__25886_25894,(1),null);
var u_z_25897 = cljs.core.nth.call(null,vec__25886_25894,(2),null);
var vec__25887_25898 = cljs.core.get.call(null,map__25884_25889__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_25899 = cljs.core.nth.call(null,vec__25887_25898,(0),null);
var p_y_25900 = cljs.core.nth.call(null,vec__25887_25898,(1),null);
var p_z_25901 = cljs.core.nth.call(null,vec__25887_25898,(2),null);
quil.core.camera.call(null,p_x_25899,p_y_25900,p_z_25901,(p_x_25899 + c_x_25891),(p_y_25900 + c_y_25892),(p_z_25901 + c_z_25893),u_x_25895,u_y_25896,u_z_25897);
